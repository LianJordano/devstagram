        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-lg">
            <form action=" {{ route("register") }} " method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="password" name="password" type="password" placeholder="Tu password de registro" class="border p-3 w-full rounded-lg @error("password") border-red-500 @enderror" value={{ old("password") }}>
                    @error("password")
                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirma tu password de registro" class="border p-3 w-full rounded-lg">
                </div>
